...
#                     print(Y_train.shape)
                    ...
                    if Y_train.numel() == 0 or Y_train.unique().numel() < 2:
                        raise ValueError("No valid labels found for model training in batch.")
                ...
                if torch.tensor(train_truth).numel() == 0 or torch.tensor(train_truth).unique().numel() < 2:
                    raise ValueError("No valid labels found for model training after epoch.")
