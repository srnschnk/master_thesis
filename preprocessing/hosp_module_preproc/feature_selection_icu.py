...
def feature_icu(cohort_output, diag_flag=True,out_flag=True,chart_flag=True,proc_flag=True,med_flag=True):
    base_path = 'data/mimiciv/2.0'
    if diag_flag:
        full_path = base_path + "/hosp/diagnoses_icd.csv.gz"
    ...
    if out_flag:  
        ...
        out = preproc_out("./"+base_path+"/icu/outputevents.csv.gz", './data/cohort/'+cohort_output+'.csv.gz', 'charttime', dtypes=None, usecols=None)
    ...
    if chart_flag:
        ...
        chart=preproc_chart("./"+base_path+"/icu/chartevents.csv.gz", './data/cohort/'+cohort_output+'.csv.gz', 'charttime', dtypes=None, usecols=['stay_id','charttime','itemid','valuenum','valueuom'])
    ...
    if proc_flag:
        ...
        proc = preproc_proc("./"+base_path+"/icu/procedureevents.csv.gz", './data/cohort/'+cohort_output+'.csv.gz', 'starttime', dtypes=None, usecols=['stay_id','starttime','itemid'])
    ...
    if med_flag:
        ...
        med = preproc_meds("./"+base_path+"/icu/inputevents.csv.gz", './data/cohort/'+cohort_output+'.csv.gz')
